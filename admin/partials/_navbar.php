      ...
      <ul class="navbar-nav navbar-nav-right">
          ...
          <li class="nav-item nav-profile dropdown">
            <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" id="profileDropdown">
              <img src="http://localhost/airlines/<?php echo $loggedUser[0]['image'] ?>" class="img img-rounded" style="height:50px;width:50px " alt="profile"/>
              <span class="nav-profile-name"><?php echo strtoupper($loggedUser[0]['uname']) ?></span>
            </a>
