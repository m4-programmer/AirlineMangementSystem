            ...
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <form class="pt-3" action="handler/login.handler.php" method="post">
                <div class="form-group">
                  <input type="password" name="email" class="form-control form-control-lg" id="exampleInputEmail1" value="<?php if(isset($_GET['email']))echo  $_GET['email'] ?>"placeholder="Email">
                </div>
                <div class="form-group">
                ...
                <div class="mt-3">
                  <button class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" name="signin" >Change Password</button>
                </div>
